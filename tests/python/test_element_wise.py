...
def test_binary_f(lhs_is_mat, rhs_is_mat):
    ...
    assert test_utils.allclose(x[7], (y == z).astype(np.float32))
    assert test_utils.allclose(x[8], (y != z).astype(np.float32))
    assert test_utils.allclose(x[9], (y > z).astype(np.float32))
    assert test_utils.allclose(x[10], (y >= z).astype(np.float32))
    assert test_utils.allclose(x[11], (y < z).astype(np.float32))
    assert test_utils.allclose(x[12], (y <= z).astype(np.float32))
...
def test_binary_i(is_mat):
    ...
    assert test_utils.allclose(x[8], (y == z).astype(np.int32))
    assert test_utils.allclose(x[9], (y != z).astype(np.int32))
    assert test_utils.allclose(x[10], (y > z).astype(np.int32))
    assert test_utils.allclose(x[11], (y >= z).astype(np.int32))
    assert test_utils.allclose(x[12], (y < z).astype(np.int32))
    assert test_utils.allclose(x[13], (y <= z).astype(np.int32))
